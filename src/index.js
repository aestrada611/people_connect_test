    ...
    const handleCompare = async () => {
        try {
            ...
            if (selectedCharacter1 && selectedCharacter2) {
                ...
                if (sharedFilms.length > 0 && (sharedStarships > 0 || sharedVehicles > 0 || sharedHomeworld.length > 0)) {
                    setAlertMessage(`${name1} and ${name2} have appeared in the following films together:`);
                }

                console.log(sharedFilms, sharedHomeworld, sharedStarships, sharedVehicles);
            }
